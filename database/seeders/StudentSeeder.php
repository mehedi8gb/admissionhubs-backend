...
class StudentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Student::factory(10)->create()->each(function ($student) {
            ...
            RefuseHistory::factory(rand(1, 3))->create(['student_id' => $student->id]);
            WorkDetail::factory(rand(1, 3))->create(['student_id' => $student->id]);
            AssignStaff::factory(rand(1, 3))->create(['student_id' => $student->id]);
            EnglishLanguageExam::factory(rand(1, 3))->create(['student_id' => $student->id]);
