    ...
    public function store(StoreStudentRequest $request): JsonResponse
    {
        ...
        try {
            ...
            $student = new Student([
                ...
                'academic_year_id' => $validatedData['academicHistory']['academicYearId'],
                'term_id' => $validatedData['academicHistory']['termId'],
    ...
    public function update(UpdateStudentRequest $request, string $id): JsonResponse
    {
        ...
        try {
            ...
            $student->update([
                ...
                'academic_year_id' => $validatedData['academicHistory']['academicYearId'] ?? $student->academic_year,
                'term_id' => $validatedData['academicHistory']['termId'] ?? $student->term,
